...
To make use of this pipeline 2 files must be provided by the user, a distiller schedule with a definition for which weights will be pruned, and a \acrshort{wandb} configuration file which defines the type and ranges of the parameters it will seek to optimize.
...
\subsection{Passing pruned/trained networks to benchmarker}
...
\subsection{Experiment 1: Rapid pruning, no retraining}
