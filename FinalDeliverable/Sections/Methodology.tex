...
%! ---------------------------------------------------------------------------------------------------------------------------------
\newpage
\subsubsection{Filter Pruning algorithm}
...
Upon completion of pruning the filters we now retrain the network to regain lost accuracy, in general pruning the more resilitent layers once and retraining can result in much of the lost accuracy to be regained~.
