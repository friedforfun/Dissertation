...
\begin{figure}[H]
    ...
    \caption{Each pruner target sparisity plotted against mean Latency.}
...
This chart does obfuscate any relationship between the parameters, however we can see how pruning the filter pruner on Layer 3.2 (red) has a much greater impact on latency than Pruning on Layer 1 (blue), this is also supported by computing the correlation between these values.
Table~\ref{tab:fastPruneCorrelations} shows the correlations between each pruning parameter and Latency and Top1
